...
/// <summary>
/// Programmatic mirror of authz/model.fga.
/// If model.fga changes, this must change too — divergence will surface in integration tests
/// that load the DSL directly.
/// </summary>
    ...
    private static TypeDefinition DelegationType() => new()
    {
        ...
        Metadata = new Metadata
        {
            Relations = new Dictionary<string, RelationMetadata>
            {
                ...
                // [user] for indefinite + [user with not_expired] for time-bound
